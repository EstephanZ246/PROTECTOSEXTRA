...
PSECT udata_bank0; common memory
    ...
    CONTADOR_TIMER1: DS 1
    CONTROL_NUMEROS: DS 1
    CONTROL_SALIDAS: DS 1
    BANDERA_UD: DS 1
    ...
    TRANSFORMADO_DECENA: DS 1
    TRANSFORMADO_UNIDAD: DS 1
 ...
 GOTO MAIN
    ...
    BTFSC BANDERA_UD,0
    GOTO VERIFICAR_PARA_DECENA_MORSEE1
...
LOOP:
   ...
   CAMBIAR_VISUALIZACION_RECIENTES:
   BTFSC PORTEV,0
   BSF PORTE,0
   BTFSC PORTEV,1
   BSF PORTE,1
 ...
 CALL TABLAS
 CALL TABLAS_REVERSA
 MOVWF TRANSFORMADO_DECENA
 MOVF MORSEUNIDAD3,W
 CALL TABLAS
 CALL TABLAS_REVERSA
 MOVWF TRANSFORMADO_UNIDAD

 MOVLW 5
 MOVWF CONTROL_SALIDAS
 MOVLW 1
 SUBWF CONTROL_SALIDAS,F
 BTFSS TRANSFORMADO_UNIDAD,0
 GOTO $+5
 BSF PORTC,4
 CALL TIMER_PUNTO
 BCF PORTC,4
 CALL TIMER_PUNTO
 BTFSC TRANSFORMADO_UNIDAD,0
 GOTO $+5
 BSF PORTC,4
 CALL TIMER_GUION
 BCF PORTC,4
 ...
 MOVLW 1
 SUBWF CONTROL_SALIDAS,F
 BTFSS TRANSFORMADO_DECENA,0
 GOTO $+5
 BSF PORTC,4
 CALL TIMER_PUNTO
 BCF PORTC,4
 CALL TIMER_PUNTO
 BTFSC TRANSFORMADO_DECENA,0
 GOTO $+5
 BSF PORTC,4
 CALL TIMER_GUION
 BCF PORTC,4
